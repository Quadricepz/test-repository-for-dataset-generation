...
void Adafruit_TCS34725::write8(uint8_t reg, uint32_t value) {
    uint8_t data[2] = {(uint8_t)(TCS34725_COMMAND_BIT | reg), (uint8_t)(value & 0xFF)};
    i2c_write_blocking(I2C_PORT, TCS34725_ADDRESS, data, 2, false);
}
...
uint8_t Adafruit_TCS34725::read8(uint8_t reg) {
    ...
    i2c_write_blocking(I2C_PORT, TCS34725_ADDRESS, &command, 1, true);
    i2c_read_blocking(I2C_PORT, TCS34725_ADDRESS, &data, 1, false);
    return data;
}
...
uint16_t Adafruit_TCS34725::read16(uint8_t reg) {
    ...
    uint8_t command = TCS34725_COMMAND_BIT | reg;
    i2c_write_blocking(I2C_PORT, TCS34725_ADDRESS, &command, 1, true);
    i2c_read_blocking(I2C_PORT, TCS34725_ADDRESS, buffer, 2, false);
